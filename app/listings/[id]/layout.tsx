...
export default async function ListingDetailLayout({ children, params }: {
    ...
    return (<>
      ...
      {listing ? (<div>
          <div>
            <div>
              {listing.status === "ACTIVE" ? (<TimedOfferWindowPanel isOfferable={listing.type === "OFFERABLE"} isOwner={userId === listing.sellerId} currentOfferAmount={listing.currentOfferAmount} offerCount={offerCount} nextOfferExpiry={nextOfferExpiry}/>) : null}
