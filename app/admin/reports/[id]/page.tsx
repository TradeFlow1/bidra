                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {!isResolved ? (
                    <form action="/api/admin/listings/delete" method="post">
                      ...
                      <input type="hidden" name="reportId" value={report.id} />
                      <input type="hidden" name="backTo" value={"/admin/reports/" + report.id} />
                      <ConfirmSubmitButton className="bd-btn bd-btn-ghost !border-red-200 !bg-red-50 !text-red-900" confirmMessage="Remove this listing from public view after reviewing the report evidence?">
                        Delete listing
                      </ConfirmSubmitButton>
                    </form>
                  ) : null}
