        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-[1fr_380px]">
          ...
          <aside className="space-y-4">
            {supportRoutes.map((item) => (
              <Link key={item.href} href={item.href} className="block rounded-[24px] border border-[#D8E1F0] bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-[0_18px_42px_rgba(15,23,42,0.10)]">
