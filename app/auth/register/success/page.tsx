    ...
    <PublicContentPage title="Check your email" subtitle="Your Bidra account is almost ready.">
      <section className="max-w-2xl rounded-[24px] border border-[#D8E1F0] bg-white p-8 shadow-sm">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row">
          <Link href="/auth/login" className="inline-flex h-12 items-center justify-center rounded-2xl bg-[#4F46E5] px-6 text-sm font-black !text-white disabled:!text-white">Sign in</Link>
          <Link href="/help" className="inline-flex h-12 items-center justify-center rounded-2xl border border-[#C7D2FE] bg-white px-6 text-sm font-black text-[#4F46E5] ">Get help</Link>
        </div>
      </section>
    </PublicContentPage>
  );
