  ...
  return (
    <PublicContentPage title="Verify your account" subtitle="Confirm your email to finish setting up Bidra.">
      <section className="max-w-2xl rounded-[24px] border border-[#D8E1F0] bg-white p-8 shadow-sm">
        ...
        <Link href="/auth/login" className="mt-7 inline-flex h-12 items-center justify-center rounded-2xl bg-[#4F46E5] px-6 text-sm font-black !text-white disabled:!text-white">Back to sign in</Link>
      </section>
    </PublicContentPage>
  );
}