    ...
    <PublicContentPage title="Choose a new password" subtitle="Create a secure password for your Bidra account.">
      <section className="max-w-2xl rounded-[24px] border border-[#E2E8F0] bg-white p-8 shadow-sm">
        ...
        <form action="/api/auth/password-reset/confirm" method="post" className="mt-5 space-y-5">
          ...
          <button type="submit" disabled={!token} className="h-12 w-full rounded-2xl bg-[#4F46E5] text-sm font-black text-white hover:bg-[#4338CA] disabled:cursor-not-allowed disabled:opacity-60">Update password</button>
        </form>
