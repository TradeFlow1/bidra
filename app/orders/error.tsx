  ...
  return (
    <BidraAccountShell>
      <BidraCard className="p-6">
        <h1 className="text-2xl font-black text-[#0F172A]">Orders could not load</h1>
        <p className="mt-2 text-sm font-semibold leading-6 text-[#475569]">Try again, or return to your account while we fix the order view.</p>
