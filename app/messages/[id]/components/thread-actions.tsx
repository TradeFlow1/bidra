    ...
    <div className="flex flex-col gap-2">
      <div className="flex gap-2">
        <button
          ...
          disabled={busy}
          className="inline-flex items-center justify-center rounded-xl border border-[#D8E1EA] bg-white/5 px-4 py-2.5 text-sm font-semibold text-[var(--bidra-ink)] hover:bg-white/10 disabled:opacity-50"
        >
