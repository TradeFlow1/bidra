    ...
    return (
      <main className="bd-container py-5 sm:py-10">
        <div className="container max-w-5xl space-y-4 sm:space-y-5">
          <BackLink href="/dashboard" label="Back to account" />
          <InboxAutoRefresh />
            ...
            <div className="rounded-3xl border border-dashed border-black/15 bg-neutral-50 px-6 py-12 text-center shadow-sm">
              <div className="mx-auto max-w-xl">
                ...
                <div className="mt-5 flex flex-wrap justify-center gap-2">
                  <Link href="/listings" className="bd-btn bd-btn-secondary w-full text-center sm:w-auto">
                    Browse listings
                  </Link>
                  <Link href="/dashboard" className="bd-btn bd-btn-secondary w-full text-center sm:w-auto">
                    Back to dashboard
                  </Link>
                </div>
              </div>
        ...
        <div className="container max-w-5xl space-y-4 sm:space-y-5">
          ...
          <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Link className="bd-btn bd-btn-secondary w-full text-center sm:w-auto" href="/dashboard">Dashboard</Link>
              <Link className="bd-btn bd-btn-secondary w-full text-center sm:w-auto" href="/support">Support</Link>
            </div>
          </div>
        </div>
      </main>
