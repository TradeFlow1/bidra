      ...
      <section className="max-w-2xl rounded-[24px] border border-[#D8E1F0] bg-white p-8 shadow-sm">
        <form action="/api/auth/password-reset/request" method="post" className="space-y-5">
          <label className="block">
            ...
            <input name="email" type="email" className="mt-2 h-12 w-full rounded-2xl border border-[#CBD5E1] bg-white px-4 text-sm font-semibold text-[#07152E] placeholder:text-[#94A3B8] outline-none transition focus:border-[#4F46E5] focus:ring-4 focus:ring-[#C7D2FE]" placeholder="you@example.com" />
          </label>
