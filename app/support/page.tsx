  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-10">
      ...
      <section className="mt-6 rounded-2xl border border-black/10 bg-white p-6">
        ...
        <ul className="mt-3 list-disc pl-5 text-black/75 space-y-2">
          <li>Someone asks you to pay “outside Bidra” to avoid fees.</li>
          <li>Someone offers overpayment with a request to refund the difference.</li>
          <li>Someone refuses pickup inspection but insists you pay immediately.</li>
      ...
      <section className="mt-6 rounded-2xl border border-black/10 bg-white p-6">
        ...
        <p className="mt-3 text-black/75">
          Most issues are resolved between buyer and seller. If you can’t resolve it, contact Support with your order
          ID, listing link, and evidence. Bidra may take platform actions (like removing listings or restricting
          accounts) but does not act as a seller, escrow holder, or payment provider.
        </p>
      </section>
