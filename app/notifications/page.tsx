    ...
    <ReferencePage>
      <div className={appNarrowShell + " space-y-4 py-5 sm:py-7"}>
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <div className="rounded-2xl border border-[#D8E1F0] bg-white px-4 py-3 sm:hidden"><div className="text-xs font-black uppercase tracking-[0.18em] text-[#0B4DFF]">Mobile updates</div><div className="mt-1 text-xs font-semibold text-[#526173]">Unread messages and order actions at a glance.</div></div>
          <div className="hidden sm:block rounded-2xl border border-[#D8E1F0] bg-white px-4 py-3"><div className="text-xs font-black uppercase tracking-[0.18em] text-[#0B4DFF]">Desktop updates workspace</div><div className="mt-1 text-xs font-semibold text-[#526173]">Triage inbox, orders, and feedback queue from one area.</div></div>
        </div>
