...
- [x] AUDIT-ADM-01: Scan EVERY admin page end-to-end: broken UI + policy correctness.
- [x] AUDIT-OTHER-01: Scan non-FT-impact pages: note issues but do not regress FT.
