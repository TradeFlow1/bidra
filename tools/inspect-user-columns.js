...
async function main() {
  const sql = "select column_name, data_type from information_schema.columns where table_name = 'User' order by ordinal_position";
...
main()
  .catch((err) => {
    console.error('INSPECT_USER_COLUMNS_ERROR');
    console.error(err);
    process.exitCode = 1;
  })
  .finally(async () => {
