...
[System.IO.File]::WriteAllLines((Resolve-Path -LiteralPath $path), $out, (New-Object System.Text.UTF8Encoding($false)))
Write-Host '[OK] rewrote create route timed-offers parity'
