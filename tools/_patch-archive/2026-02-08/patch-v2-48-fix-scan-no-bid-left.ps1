...
# Build scanner content as literal lines (no $ expansion)
$scanner = @(
  "#Requires -Version 5.1"
  "$ErrorActionPreference = 'Stop'"
  ""
...
# Write scanner as UTF-8 without BOM
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)
$scannerFile = Join-Path $repoRoot "tools\v2-48-scan-no-bid-left.ps1"
[System.IO.File]::WriteAllLines($scannerFile, $scanner, $utf8NoBom)
Write-Host ("Rewrote scanner: {0}" -f $scannerFile)
