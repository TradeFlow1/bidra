...
if ($Branch -ne "fix/UX-03-remove-native-dialogs") { throw "Wrong branch. Expected fix/UX-03-remove-native-dialogs but found $Branch" }
node .\tools\ux-03-native-dialog-check.cjs
