...
if ($Branch -ne "fix/AUTH-05-signup-login-confidence") {
    throw "Wrong branch. Expected fix/AUTH-05-signup-login-confidence but found $Branch"
}

node .\tools\auth-05-signup-login-confidence-check.cjs
