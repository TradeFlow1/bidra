...
if ($Branch -ne "fix/SUPPORT-01-logged-out-support") {
    throw "Wrong branch. Expected fix/SUPPORT-01-logged-out-support but found $Branch"
}

node .\tools\support-01-logged-out-support-check.cjs
