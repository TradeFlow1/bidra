...
type MarketplaceIconName = "home" | "browse" | "sell" | "messages" | "account" | "search" | "heart" | "safe" | "handover" | "offer" | "listing";
...
export function TrustBadge({ title, description, icon = "safe" }: { title: string; description?: string; icon?: MarketplaceIconName | string }) {
  const valid = ["home", "browse", "sell", "messages", "account", "search", "heart", "safe", "handover", "offer", "listing"].includes(icon);
