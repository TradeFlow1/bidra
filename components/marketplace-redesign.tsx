      ...
      <section className="md:hidden">
        <div className="rounded-[26px] border border-[#C7D2FE] bg-[linear-gradient(135deg,#F8FBFC_0%,#EEF2FF_100%)] p-5 shadow-[0_18px_50px_rgba(32,75,140,0.10)]">
          ...
          <div className="mt-5 grid gap-3">
            ...
            <Link href={sellHref} className="flex h-12 items-center justify-center rounded-2xl border border-[#C7D2FE] bg-white px-5 text-sm font-black text-[#4F46E5] shadow-sm">
              Sell an item
            </Link>
          </div>
        ...
        <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(520px,0.95fr)] lg:items-center">
          <div>
            ...
            <div className="mt-5 flex gap-3">
              ...
              <Link href={sellHref} className="inline-flex h-12 items-center justify-center rounded-2xl border border-[#C7D2FE] bg-white px-6 text-sm font-black text-[#4F46E5] shadow-sm">
                Sell an item
              </Link>
            </div>
    ...
    <div className="relative hidden grid-cols-2 gap-4 sm:grid lg:grid lg:min-h-[430px]">
      ...
      {heroListings.map((item, index) => (
        ...
        >
          ...
          <span className="absolute bottom-12 left-3 max-w-[calc(100%-24px)] truncate rounded-full bg-white px-3 py-1 text-xs font-black text-[#4F46E5] shadow-lg ring-1 ring-[#C7D2FE]">
            {item.title}
          </span>
    ...
    <section className="my-8 hidden overflow-hidden rounded-[30px] bg-[#0F172A] text-white shadow-[0_24px_80px_rgba(7,21,46,0.22)] md:block">
      <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[0.65fr_1fr_0.65fr] lg:items-center">
        <div className="hidden h-36 overflow-hidden rounded-[26px] border border-white/10 bg-white/10 p-4 lg:block">
          <div className="h-full rounded-[22px] bg-white p-4 text-[#4F46E5] shadow-2xl">
        ...
        <div className="flex flex-wrap gap-3 lg:justify-end">
          <Link href="/listings" className="rounded-xl border border-white/20 bg-white px-4 py-2 text-xs font-black text-[#4F46E5]">Browse listings</Link>
