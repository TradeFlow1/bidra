        ...
        <div className="grid gap-8 lg:grid-cols-[1.25fr_2fr_1fr] lg:items-start">
          <div>
            ...
            <div className="mt-4 flex gap-2" aria-label="Social links">
              {["f", "i", "x"].map((item) => (
                <span key={item} className="grid h-8 w-8 place-items-center rounded-full border border-[#D7E2F1] bg-[#F8FAFF] text-xs font-black uppercase text-[#607089]">{item}</span>
              ))}
            </div>
          </div>
