export function BrowseHeader({
  ...
  return (
    <div className="mb-7 overflow-hidden rounded-[36px] border border-[#E8E2F4] bg-[radial-gradient(620px_260px_at_90%_-60px,rgba(124,58,237,0.16),transparent_72%),linear-gradient(135deg,#FFFFFF_0%,#FBFAFF_58%,#F5F3FF_100%)] p-6 shadow-[0_26px_90px_rgba(18,7,36,0.10)] lg:flex lg:items-end lg:justify-between lg:gap-8">
      <div>
