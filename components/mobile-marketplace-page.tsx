...
export function MobilePrimaryButton({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link href={href} className="flex h-12 items-center justify-center rounded-xl bg-[#4F46E5] px-4 text-sm font-black text-white shadow-[0_12px_26px_rgba(79,70,229,0.22)]">
      {children}
    </Link>
  );
}
