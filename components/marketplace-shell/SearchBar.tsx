...
export default function SearchBar({
  ...
  return (
    <section className={compact ? "mk-search mk-search-compact" : "mk-search"} aria-label="Marketplace search panel">
      <div className="mk-search-modes" aria-hidden="true">
        <span className="mk-search-mode mk-search-mode-active">Listings</span>
        <span className="mk-search-mode">Offers</span>
        <span className="mk-search-mode">Buy Now</span>
      </div>
      <form className="mk-search-row" action="#" role="search">
