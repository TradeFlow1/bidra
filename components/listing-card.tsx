...
export default function ListingCard({
  ...
  return (
    <Link
      ...
      className="bd-marketplace-card group block overflow-hidden rounded-[24px] border border-[#D8E6F8] bg-white shadow-sm transition hover:-translate-y-0.5 hover:border-[#AFC8F8] hover:shadow-[0_18px_50px_rgba(32,75,140,0.14)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300 hover:bg-[#F5F3FF]"
      aria-label={"View listing " + title}
    >
      <div className="overflow-hidden bg-white hover:bg-[#F5F3FF]">
        <div className="relative aspect-[1/0.92] overflow-hidden bg-[#EEF3FA]" style={{ position: "relative", aspectRatio: "1 / 0.92", width: "100%", maxWidth: "100%", overflow: "hidden", background: "#EEF3FA" }}>
          ...
          {showWatchButton ? (
            <button
              ...
              className="absolute right-2.5 top-2.5 z-10 flex h-9 w-9 items-center justify-center rounded-full border border-white/80 bg-white/95 text-[18px] text-[#0E7490] shadow-[0_8px_20px_rgba(28,50,84,0.16)] transition hover:scale-105 hover:bg-[#F5F3FF]"
